...
impl HtmlCapture2D {
    ...
    pub fn from_canvas(canvas: HtmlCanvasElement) -> Result<Option<Self>, js_sys::Error> {
...
impl CaptureArea for HtmlCapture2D {
...
impl BrowserVideoCapture for HtmlCapture2D {
    fn capture(
        &self,
